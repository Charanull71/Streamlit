    ...
    if col1.button("Retrieve"):
        try:
            for collection_name in selected_collections:
                ...
                if role == "HOD":
                    data = retrieve_data_from_collection( collection_name=collection_name, start_date=start_date, end_date=end_date, file_fields=file_fields)
                else:
    ...
    if col2.button("Retrieve All Data"):
        try:
            for collection_name in selected_collections:
                ...
                if role == "HOD":
                    data = retrieve_data_from_collection(collection_name=collection_name, file_fields=file_fields)
                else:
